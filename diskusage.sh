...
ssh -p 1291 $userName@$domainName -t "du ~ > ./fileusage.txt"
scp -P 1291 $userName@$domainName:fileusage.txt ~/Documents/Website_Cleanup/$userName-fileusage.txt
ssh -p 1291 $userName@$domainName -t "rm -rf ~/fileusage.txt"
